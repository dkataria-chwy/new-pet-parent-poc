...
from nppState import nppState, SlotSpec, CandidateProduct  # models & fields used downstream
import agent_helper_function  # pet_context_helper
...
def candidate_eval_agent(state: nppState) -> nppState:
    """
    ...
    """
    if not getattr(state, "slots", None):
        return state
